if distance_to_object(argument0) >= argument1 && mp_potential_path_object(path,argument0.x,argument0.y,10,4,par_wall)
{   
    var path_x = path_get_point_x(path,2);
    var path_y = path_get_point_y(path,2);
...
if(collision_line(x,y,argument0.x,argument0.y,par_wall,false,true))
    scr_turn(vdir,10)
else
